...
export const IeltsNews: React.FC<{ieltsNews: ListNews[]}> = ({ieltsNews}) => {
  return (
    <section id="ielts news" className="px-[16px] md:px-[80px] py-12 md:py-16 bg-white">
      <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-2 place-items-top">
        {ieltsNews.map(({title,description,image,publishInfor,tag,href}, index) => (
