...
export const FooterSection = () => {
  return (
    <footer id="footer" className="container bg-card border border-secondary w-[1440px] h-[525px] gap-12 py-[60px] px-[120px] bg-[#f2f4f7]">
        ...
        <div className="top-4 grid grid-cols-3">
          ...
          <div className="w-[94px] h-[172px] gap-[16px] flex flex-col justify-center text-center">
            ...
            <div>
              <Link href="/về chúng tôi" className="text-black hover:opacity-100">
                Về chúng tôi
              </Link>
            </div>
