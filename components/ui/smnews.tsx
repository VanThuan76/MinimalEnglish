        ...
        <div className='flex flex-col w-full gap-6 h-full'>
            ...
            <div className='w-full flex flex-col gap-3 justify-between text-black flex-grow'>
                <div className='w-full flex justify-between items-center'>
                    <Badge variant={'secondary'} className='flex justify-center p-2 rounded-lg bg-[#E4E7EC] text-black text-xs font-normal min-w-[74px] 2xl:text-base'>{tag}</Badge>
                    <div className='text-base font-normal 2xl:text-lg'>{publishInfor}</div>
                </div>

                <div className='text-2xl font-semibold leading-9 2xl:text-3xl'>
                    {title}
                </div>
